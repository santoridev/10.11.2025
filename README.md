...
## Реализация безопасной остановки и обработки задач

При разработке сервиса была важная цель — обеспечить возможность его корректной перезагрузки или остановки без потери задач, которые уже находятся в обработке. Также нужно было предусмотреть ситуацию, когда во время остановки в сервис продолжают поступать новые запросы.
Для этого были применены стандартные и рекомендуемые практики Go, описанные ниже.
